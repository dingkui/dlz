...
public class RbacServiceImpl implements RbacService {
	...
	public String getCode(String pCode,String codeName,String tableName) throws Exception{
		SearchParaMap spm = new SearchParaMap(tableName,"ifnull(max("+codeName+"),'') as code");
...
//		spm.createPage().setOrderBy("code desc");
		...
		if(o==null || "".equals(o)){
			...
			String subCodeStr = o.substring(pCode.length());
			if(StringUtils.isBlank(subCodeStr)){
				return pCode+"01";
			}
			int maxSub=Integer.parseInt(subCodeStr,16)+1;
