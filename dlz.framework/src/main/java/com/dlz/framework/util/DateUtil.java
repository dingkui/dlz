...
public class DateUtil {
	...
	static public long getDistinceDay(Date beforedate, Date afterdate) {
		long dayCount = (afterdate.getTime() - beforedate.getTime()) / (24 * 60 * 60 * 1000);
		return dayCount;
	}
	...
	public static SimpleDateFormat SIMPLE_DAT_FORMAT = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
